...
func (pc *PostCreate) SetNillableDate(t *time.Time) *PostCreate {
	if t != nil {
		pc.SetDate(*t)
	}
	return pc
...
func (pc *PostCreate) SetNillableCategory(s *string) *PostCreate {
	if s != nil {
		pc.SetCategory(*s)
	}
	return pc
...
func (pc *PostCreate) SetTag(s []string) *PostCreate {
